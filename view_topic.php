...
<link rel="stylesheet" type="text/css" href="css/view_topic.css">
</head>
<?php
session_start();
...
<input type="hidden" name="a_email" value="<?php echo $email ?>"/>
<input type="hidden" name="a_name" value="<?php echo $name ?>"/>
<tr>
